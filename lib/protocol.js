 ...
 * @param {Function}   [cb]
 */
Protocol.prototype.requestSetUrl = function (url, con, cb) {
 ...
 * @param {Function}   [cb]
 */
Protocol.prototype.requestSetPanicUrl = function (url, con, cb) {
    this.sendRequest(this.REQUEST, {
        action: 'setPanicUrl',
        url: url
    }, con, cb);
 ...
 * @param {Function}   [cb]
 */
Protocol.prototype.requestSetPanicState = function (state, con, cb) {
    this.sendRequest(this.REQUEST, {
        action: 'setPanicState',
        url: state
    }, con, cb);
};
