    ...
    '<div class="heading"> \
         ...
         <div class="pull-right">\
             <div class="btn-group btn-group-config">\
                 {{#editable}}<button type="button" class="btn btn-sm btn-default  js-button-changeurl-all" data-toggle="collapse" data-target="#collapse-{{id}}" aria-expanded="false" aria-controls="collapse-{{id}}"><i class="fa fa-fw fa-lg fa-terminal"></i></button>{{/editable}}\
                 <button type="button" class="btn btn-sm btn-default {{^settings}}active{{/settings}} js-settings"><i class="fa fa-fw fa-lg fa-cog"></i></button>\
             </div>\
             <div class="btn-group">\
